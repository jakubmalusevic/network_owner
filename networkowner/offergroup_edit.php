...
if (($_REQUEST[id] != '') && ($_REQUEST[tryout] == '')) {
    $sql = "SELECT * FROM `offergroups` WHERE `id`='{$_REQUEST[id]}'";
    //var_dump($sql);exit;
    $q = mysql_query($sql);
...
if ($_REQUEST[tryout] == '1') {
    ...
    if ($errmsg != '') {
        ...
        $offergroup_id = $_REQUEST[id];      
        
        $str_offergroupdesc = $_REQUEST[description];
        $str_offergroupdesc = str_replace("<a href","<a target=\"_blank\" href", $str_offergroupdesc);      
        $str_offergroupdesc = str_replace("“","\"", $str_offergroupdesc);      
        $str_offergroupdesc = str_replace("”","\"", $str_offergroupdesc); 
         
        //var_dump($_REQUEST[registry_path]);exit;              
        $sql = "UPDATE `offergroups` SET         
            `name`='{$_REQUEST[name]}',            
            `description`='{$str_offergroupdesc}',
            `offer1_id`='{$_REQUEST[offer1_id]}',
            `isdefault_1`='{$_REQUEST[isdefault_1]}',
            `offer2_id`='{$_REQUEST[offer2_id]}',
            `isdefault_2`='{$_REQUEST[isdefault_2]}',
            `offer3_id`='{$_REQUEST[offer3_id]}',
            `isdefault_3`='{$_REQUEST[isdefault_3]}',
            `offer4_id`='{$_REQUEST[offer4_id]}',
            `isdefault_4`='{$_REQUEST[isdefault_4]}',
            `offer5_id`='{$_REQUEST[offer5_id]}',
            `isdefault_5`='{$_REQUEST[isdefault_5]}'
            WHERE `id`='{$offergroup_id}'
            ";                     
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                            <form action="offergroup_edit.php" class="form-horizontal" method="POST" id="add_form">
                                    ...
                                    <div class="controls form-inline" style="margin-left: 50px; float: left; width: 300px;">
                                        <select class="span6 chosen" name='offer1_id' style="width: 240px;" >
                                            ...
                                            while ($row1 = mysql_fetch_assoc($q1)) {
                                                ?>
                                                <option value="<?= $row1[id] ?>" <? if ($_REQUEST[offer1_id] == $row1[id]) echo 'SELECTED'; ?>><?= $row1[offer_name]?></option>
                                            <? } ?>
                                        </select>
                                    </div> 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls form-inline" style="margin-left: 50px; float: left; width: 300px;">
                                        <select class="span6 chosen" name='offer2_id' style="width: 240px;" >
                                            ...
                                            while ($row1 = mysql_fetch_assoc($q1)) {
                                                ?>
                                                <option value="<?= $row1[id] ?>" <? if ($_REQUEST[offer2_id] == $row1[id]) echo 'SELECTED'; ?>><?= $row1[offer_name]?></option>
                                            <? } ?>
                                        </select>
                                    </div> 
                                    <label class="control-label" for="input3"> IsDefault </label>   
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls form-inline" style="margin-left: 50px; float: left; width: 300px;">
                                        <select class="span6 chosen" name='offer3_id' style="width: 240px;" >
                                            ...
                                            while ($row1 = mysql_fetch_assoc($q1)) {
                                                ?>
                                                <option value="<?= $row1[id] ?>" <? if ($_REQUEST[offer3_id] == $row1[id]) echo 'SELECTED'; ?>><?= $row1[offer_name]?></option>
                                            <? } ?>
                                        </select>
                                    </div> 
                                    <label class="control-label" for="input3"> IsDefault </label>   
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls form-inline" style="margin-left: 50px; float: left; width: 300px;">
                                        <select class="span6 chosen" name='offer4_id' style="width: 240px;" >
                                            ...
                                            while ($row1 = mysql_fetch_assoc($q1)) {
                                                ?>
                                                <option value="<?= $row1[id] ?>" <? if ($_REQUEST[offer4_id] == $row1[id]) echo 'SELECTED'; ?>><?= $row1[offer_name]?></option>
                                            <? } ?>
                                        </select>
                                    </div> 
                                    <label class="control-label" for="input3"> IsDefault </label>   
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls form-inline" style="margin-left: 50px; float: left; width: 300px;">
                                        <select class="span6 chosen" name='offer5_id' style="width: 240px;" >
                                            ...
                                            while ($row1 = mysql_fetch_assoc($q1)) {
                                                ?>
                                                <option value="<?= $row1[id] ?>" <? if ($_REQUEST[offer5_id] == $row1[id]) echo 'SELECTED'; ?>><?= $row1[offer_name]?></option>
                                            <? } ?>
                                        </select>
                                    </div> 
                                    <label class="control-label" for="input3"> IsDefault </label>   
