...
//    }
    ...
    {         
        ...
        echo('<script language="JavaScript">window.location.href = "adv_list.php?mode=added&id=' . $user_id . '"</script>');
        break;
    }
}
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    Add New Advertiser
                    <small>add new advertiser to the existing network</small>
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>  Add New Advertiser To The Network</h4>
                        </div>
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->


                            <form action="adv_add.php" class="form-horizontal" method="POST" id="add_form" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="checkbox">
                                            <input type="checkbox" name="adv_manager" id="adv_manager" value="1" <? if ($_REQUEST[adv_manager] == '1') echo 'CHECKED'; ?>/>
                                        </label>
                                    </div>
                                </div>
