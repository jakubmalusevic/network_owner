...
if ($_REQUEST[tryout] == '1') {
    ...
    if ($errmsg != '') {
        ...
        echo('<script language="JavaScript">window.location.href = "pub_list.php?mode=edited&id=' . $_REQUEST[id] . '"</script>');
        break;
    }
} else {
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    Edit Publisher
                    <small>edit the existing publisher</small>
                </h3>
                <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li>
                        <a href="pub_list.php">Publishers List</a> <span class="divider">/</span>
                    </li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>  Edit The Existing Publisher</h4>
                        </div>
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                            <form action="pub_edit.php" class="form-horizontal" method="POST" id="add_form" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label class="checkbox">
                                            <input type="checkbox" name="pub_manager" id="pub_manager" value="1" <? if (($_REQUEST[pub_manager] == '1') || ($_REQUEST[user_status] == '5')) echo 'CHECKED'; ?>/>
                                        </label>
                                    </div>
                                </div>
