    ...
    var handleDateTimePickers = function () {
        ...
        $('#dashboard-report-range').daterangepicker({
            ranges: {
                ...
                'Last 7 Days': [Date.today().my_add({
                    days: -6
                }), 'today'],
                'Last 30 Days': [Date.today().my_add({
                    days: -29
                }), 'today'],
                'This Month': [Date.today().moveToFirstDayOfMonth(), Date.today().moveToLastDayOfMonth()],
                'Last Month': [Date.today().moveToFirstDayOfMonth().my_add({
                    months: -1
                }), Date.today().moveToFirstDayOfMonth().my_add({
                    days: -1
                })]
            },
            opens: 'left',
        ...
        $('#dashboard-report-range span').html(Date.today().my_add({
            days: -29
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
        });

        $('#form-date-range span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        }
        ...
        $('#form-date-range1').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            ...
            $('#form-date-range1-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range1-enddate').val(end.toString('yyyy-MM-dd'));
        });
        

        $('#form-date-range1 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range1-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range1-enddate').val(Date.today().toString('yyyy-MM-dd'));
                
        }
        
        //form-date-range2
        {    
        $('#form-date-range2').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            $('#form-date-range2 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range2-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range2-enddate').val(end.toString('yyyy-MM-dd'));            
        });

        $('#form-date-range2 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range2-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range2-enddate').val(Date.today().toString('yyyy-MM-dd'));
        }
        
        //form-date-range3
        {    
        $('#form-date-range3').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range3 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range3-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range3-enddate').val(end.toString('yyyy-MM-dd'));
        });

        $('#form-date-range3 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range3-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range3-enddate').val(Date.today().toString('yyyy-MM-dd'));
        }
        
        //form-date-range4
        {    
        $('#form-date-range4').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range4 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range4-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range4-enddate').val(end.toString('yyyy-MM-dd'));
        });

        $('#form-date-range4 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range4-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range4-enddate').val(Date.today().toString('yyyy-MM-dd'));
        }
        
        //form-date-range5
        {    
        $('#form-date-range5').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range5 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range5-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range5-enddate').val(end.toString('yyyy-MM-dd'));
        });

        $('#form-date-range5 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range5-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range5-enddate').val(Date.today().toString('yyyy-MM-dd'));
        
        }
        
        //form-date-range6
        {    
        $('#form-date-range6').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range6 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range6-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range6-enddate').val(end.toString('yyyy-MM-dd'));
        });

        $('#form-date-range6 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range6-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range6-enddate').val(Date.today().toString('yyyy-MM-dd'));
        }
        
        //form-date-range7
        {    
        $('#form-date-range7').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range7 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range7-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range7-enddate').val(end.toString('yyyy-MM-dd'));
        });

        $('#form-date-range7 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range7-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range7-enddate').val(Date.today().toString('yyyy-MM-dd'));
        }
        
        //form-date-range8
        {    
        $('#form-date-range8').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().my_add({
        ...
        function (start, end) {
            var s = start.toString('MMMM d, yyyy');
            $('#form-date-range8 span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
            $('#form-date-range8-startdate').val(start.toString('yyyy-MM-dd'));
            $('#form-date-range8-enddate').val(end.toString('yyyy-MM-dd'));
        });

        $('#form-date-range8 span').html(Date.today().my_add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range8-startdate').val(Date.today().my_add({days: -29}).toString('yyyy-MM-dd'));
        $('#form-date-range8-enddate').val(Date.today().toString('yyyy-MM-dd'));
        }
...
function GetOffersByCategory_Project(proj_id,cat_id)
{
    //alert(proj_id);alert(cat_id);
    if ((proj_id=="") || (cat_id==""))
    {
    ...
    xmlhttp.onreadystatechange=function()
    {
      ...
      {         
        $("#offers_table").html(xmlhttp.responseText);
        $(".chosen-with-diselect").chosen({
            allow_single_deselect: true
        });        
      }
    }
    xmlhttp.open("GET","ajax.php?mode=getorderstable_by_categoryid&proj_id="+proj_id+"&cat_id="+cat_id,true);
    xmlhttp.send();
}