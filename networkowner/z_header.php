        ...
        <div id="container" class="row-fluid">
            ...
            <div id="sidebar" class="nav-collapse collapse">
                ...
                <ul>
                    ...
                    <li class="has-sub <? if ((strpos($_SERVER['REQUEST_URI'], 'offer_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offer_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offer_edit.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'camp_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'camp_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'camp_edit.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'category_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'category_edit.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'category_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offergroup_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offergroup_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offergroup_edit.php') == true)) echo 'active'; ?>">
                        <a href="javascript:;" class="">
