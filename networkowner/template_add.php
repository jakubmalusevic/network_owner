...
if ($_REQUEST[tryout] == '1') {
    ...
    {       
        ...
        else
        {
            ...
            $sql =  "INSERT INTO `templates`( `template_id`, `name`, 
                    `maintemplate_filepath`, `downloadtemplate_filepath`, `thanktemplate_filepath`,          
                    `img1`, `img2`, `img3`, `img4`, `img5`, `img6`, `img7`, `img8`, 
                    `img9`, `img10`, `img11`, `img12`, `img13`, `img14`, `img15`
                ) VALUES (
                '{$templ_id}', '{$_REQUEST[templ_name]}',
                '{$main_templ_path}', '{$download_templ_path}', '{$thank_templ_path}', 
