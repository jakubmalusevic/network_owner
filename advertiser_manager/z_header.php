        ...
        <div id="container" class="row-fluid">
            ...
            <div id="sidebar" class="nav-collapse collapse">
                ...
                <ul>
                    ...
                    <li class="<? if (strpos($_SERVER['REQUEST_URI'], 'adv_list.php') == true) echo 'active'; ?>">
                        <a href="adv_list.php">
                            <i class="icon-bar-chart"></i> Advertisers
                        </a>
                    </li> 
                    
                    <li class="has-sub <? if ((strpos($_SERVER['REQUEST_URI'], 'offer_list.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offer_add.php') == true) || (strpos($_SERVER['REQUEST_URI'], 'offer_edit.php') == true)) echo 'active'; ?>">
                        <a href="javascript:;" class="">
                            <i class="icon-list-alt"></i> Offers
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">                            
