var App = function () {
    ...
    var handleDateTimePickers = function () {
        ...
        $('#form-date-range1-startdate').val(Date.today().add({days: -29}).toString('yyyy-MM-dd'));
        ...
        $('#form-date-range2 span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range2-startdate').val(Date.today().add({days: -29}).toString('yyyy-MM-dd'));
        ...
        $('#form-date-range3 span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range3-startdate').val(Date.today().add({days: -29}).toString('yyyy-MM-dd'));
        ...
        $('#form-date-range4 span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range4-startdate').val(Date.today().add({days: -29}).toString('yyyy-MM-dd'));
        ...
        $('#form-date-range5 span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range5-startdate').val(Date.today().add({days: -29}).toString('yyyy-MM-dd'));
        ...
        $('#form-date-range6 span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
        
        $('#form-date-range6-startdate').val(Date.today().add({days: -29}).toString('yyyy-MM-dd'));
