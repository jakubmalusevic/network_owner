                        ...
                        <div class="widget-body form">
                            ...
                            <table class="table table-striped table-bordered" id="other_list">
                                ...
                                <tbody>
                                    ...
                                    WHERE p.assigned_user_id=um.user_id AND um.PM_id={$_SESSION[user_id]} ORDER BY um.user_id DESC";
                                    ...
                                    while ($row = mysql_fetch_assoc($q)) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="pub_edit.php?id=<?= $row[assigned_user_id] ?>"><?= $row[user_first_name] . ' ' . $row[user_last_name] ?></a></td>
                                            <td><?= $row[proj_name] ?></td>
                                            <td><?= $row[software_name] . ' ' . $row[software_version] ?></td>                                            
                                            <td><a href="../common/download.php?cid=<?= $row[id] ?>&file=<?= $row[proj_exe] ?>"><? echo($common_path_url . "download.php?cid=" . $row[id] . "&file=" . $row[proj_exe]); ?></a></td>
