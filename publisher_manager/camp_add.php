...
if ($_REQUEST[tryout] == '1') {
    ...
    if ($errmsg != '') {
        ...
        mkdir('/home/startins/public_html/secure/' . $proj_id, 0777);

        $image_file = $_SERVER['DOCUMENT_ROOT'] . '/installers/startinstaller.exe';
        $new_file = '/home/startins/public_html/secure/' . $proj_id . '/' . $_REQUEST[proj_exe];
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span6 chosen" name='assigned_user_id'>
                                            ...
                                            <?
                                            $sql1 = "SELECT id, user_name, user_first_name, user_last_name FROM `users` WHERE `user_status`=3 AND `user_manager`=" . $_SESSION["user_id"] . " ORDER BY `id` DESC";
                                            $q1 = mysql_query($sql1);
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 250px; height: 250px;"><img src="installer_logos/<?= $_REQUEST[id] ?>.jpg" alt=""/></div>
